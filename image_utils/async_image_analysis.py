...
class AsyncImageAnalysis:
    ...
    PROVIDER_CONFIGS = {
        ...
        "qianwen": {
            ...
            "base_url_env": "QIANWEN_BASE_URL",
            "model_env": "QIANWEN_VISION_MODEL", 
            "default_models": ["qwen-vl-max-2025-01-25"]
        },
        "modelscope": {
            "api_key_env": "MS_API_KEY",
            "base_url_env": "MS_BASE_URL",
            "model_env": "MS_VISION_MODEL", 
            "default_models": ["Qwen/Qwen2.5-VL-72B-Instruct"]
        }
